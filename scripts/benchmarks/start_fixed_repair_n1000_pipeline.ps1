...
$logDir = Join-Path $projectRoot "data\outputs\benchmarks_n1000\fixed_repair\logs"
...
$outputDir = "$outputRoot/fixed_repair"

$steps = @(
    @{
        Name = "run_fixed_repair_n1000"
        Args = @(
...
Write-Output "Fixed-repair n=1000 pipeline completed."
